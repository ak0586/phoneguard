...
class _FaqScreenState extends State<FaqScreen> {
  ...
  List<FaqItemData> _getFaqs(BuildContext context, bool isHi) {
    ...
    if (isHi) {
      return [
        FaqItemData(l10n.faqBasics, 'PhoneGuard क्या है?', 'यह एक सुरक्षा ऐप है जो आपके फोन के चोरी होने पर उसे वापस पाने में मदद करता है। आप इसे दूसरे फोन से मैसेज भेजकर कंट्रोल कर सकते हैं।'),
        ...
        FaqItemData(l10n.faqGeneral, 'PhoneGuard मेरा फोन कैसे ढूँढता है?', 'PhoneGuard दो तरह से काम करता है: मैसेज/चैट कमांड (ऑफलाइन/ऑनलाइन) और वेब डैशबोर्ड। आप दुनिया में कहीं से भी अपने फोन को ट्रैक, लॉक या सायरन बजा सकते हैं।'),
        ...
        FaqItemData(l10n.faqGeneral, 'क्या सिम में बैलेंस/डेटा होना चाहिए?', 'हाँ, क्योंकि ऐप लोकेशन भेजने के लिए मैसेज या इंटरनेट का उपयोग करता है, इसलिए आपके सिम में मैसेज पैक या डेटा होना चाहिए।'),
        ...
        FaqItemData(l10n.faqSecurity, 'विश्वसनीय नंबर (Trusted Numbers) क्या हैं?', 'ये वे मोबाइल नंबर हैं जिन्हें आप ऐप में जोड़ते हैं। केवल इन नंबरों से भेजे गए कमांड ही आपके फोन पर काम करेंगे।'),
        ...
        FaqItemData(l10n.faqTechnical, 'क्या यह बिना इंटरनेट के काम करता है?', 'हाँ! रिकवरी के लिए मुख्य कमांड (सायरन, लोकेशन मैसेज, लॉक) सेलुलर नेटवर्क पर काम करते हैं।'),
    ...
    return [
      FaqItemData(l10n.faqBasics, 'What is PhoneGuard?', 'It is a security app designed to help you recover your phone if it is lost or stolen. It lets you control your device remotely using simple chat messages from another phone.'),
      ...
      FaqItemData(l10n.faqGeneral, 'How does PhoneGuard find my phone?', 'PhoneGuard works in two ways: via Chat commands (Offline/Online) and via the Web Dashboard. You can track, lock, or sound a siren from anywhere in the world.'),
      ...
      FaqItemData(l10n.faqGeneral, 'Do I need balance/data?', 'Yes. Since the app sends location details back to you via messaging, your SIM card must have an active data pack or message balance to reply to your commands.'),
      ...
      FaqItemData(l10n.faqSecurity, 'What are Trusted Numbers?', 'These are the mobile numbers of your friends or family that you add in the app. Only chat commands sent from these numbers will be accepted by your phone.'),
      ...
      FaqItemData(l10n.faqTechnical, 'Does it work without internet?', 'Yes! Core recovery features like the Siren, Location via messaging, and Remote Lock work via the cellular network.'),
