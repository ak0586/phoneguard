      ...
      child: Column(
        ...
        children: [
          ...
          _buildRequirementItem(
            ...
            description: l10n.defaultActionsDesc,
            instruction: l10n.defaultActionsInstr,
            color: Colors.purple,
          ),
          _buildRequirementItem(
            context,
            ...
            title: l10n.triggerKeyword,
            description: l10n.triggerKeywordDesc,
            instruction: l10n.triggerKeywordInstr,
            color: Colors.teal,
          ),
