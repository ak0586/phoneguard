...
class PhoneUtils {
  ...
  /// Map of ISO 3166-1 alpha-2 country codes to dialing codes
  static const Map<String, String> _countryDialingCodes = {
    ...
    'IM': '+44', 'IL': '+972', 'IT': '+39', 'CI': '+225', 'JM': '+1-876',
    ...
    'TG': '+228', 'TK': '+690', 'TO': '+676', 'TT': '+1-868', 'TN': '+216',
    'TR': '+90', 'TM': '+993', 'TC': '+1-649', 'TV': '+688', 'UG': '+256',
    'UA': '+380', 'AE': '+971', 'GB': '+44', 'US': '+1', 'UY': '+598',
    'VI': '+1-340', 'UZ': '+998', 'VU': '+678', 'VA': '+379', 'VE': '+58',
  ...
  static String formatWithCountryCode(String number, String? isoCode) {
    final clean = normalize(number);
    if (clean.startsWith('+')) return clean;
    
    if (isoCode != null) {
      final dialingCode = _countryDialingCodes[isoCode.toUpperCase()];
      if (dialingCode != null) {
        // Handle cases like +1-XXX
        final prefix = dialingCode.replaceAll('-', '');
        return '$prefix$clean';
      }
    }
    return clean;
  ...
  /// Validates if the string is plausible (with or without + if we auto-fix it)
  static bool isValid(String number) {
    final cleaned = normalize(number);
    // Relaxed validation: Allow with or without + for UI check
